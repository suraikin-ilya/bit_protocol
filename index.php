...
$_SERVER['SERVER_NAME'] = polytech.ru;
...
<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="index.php"><img alt="logo" src="assets/img/BIT_Logo.png"> <span class="navbar-brand-name">BIT</span></a>
        </div>
    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing mb-4">
            ...
            <div class="col-xl-12 col-md-4">
                <a href="add.php" class="btn btn-success btn-download">Add-project</a>
            </div>
        </div>
    </div>
    <!--  END CONTENT PART  -->
